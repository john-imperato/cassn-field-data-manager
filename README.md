...
The repo includes tracked example CSVs in `example_data/` so you can create
your local copies:
...
├── example_data/                     # Tracked CSV templates and schema examples
│   ├── sites.csv                     # Site/reserve lookup example
│   └── plots.csv                     # Plot lookup example
├── local_data/                       # Real local CSVs for sites and plots (gitignored)
├── utils/
